...
| TC-02 | Check the record with a due date == today's date + 1                                            | The BR008 record exists, with status "Borrowing"                                     | 1. Log in using your Librarian account. 2. Click the "Check Expired" button.                                                    | System date: 5/23/2026. (dueDate == 5/22/2026)                       | BR008 doesn't change                               | REQ-6 | EP, BVA  |
