...
|TC-08 |Record status shows "Quá hạn" after overdue check | Logged in as librarian@library.com. BR001 (MEM002, BOOK003) is past due date 15/09/2024.|1. As Librarian, click "Kiểm tra quá hạn" button. 2. Log out, log back in as ba.nguyen@email.com. 3. Go to "Borrow/Return" tab. 4. Find BR001. |Librarian triggers overdue check. Account for viewing: ba.nguyen@email.com. Record: BR001 |1. BR001 status updates to "Quá hạn". 2. MEM002 can see BR001 with status "Quá hạn" in their own records. 3. Librarian also sees BR001 as "Quá hạn" in the full list. |REQ -08|EP |
| | | | | | | | |
---
