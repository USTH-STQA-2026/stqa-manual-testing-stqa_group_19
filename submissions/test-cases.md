...
> ### ⚠️ TC-25 → TC-26 — Ghi nhận SRS Gap (không kết luận Pass/Fail)
>
...
| ------------------------------------ | ----- | ------- | -------------------- |
| Đăng nhập                            | 7     | REQ-01  | EP                   |
| Tìm kiếm & lọc sách (có SRS rõ ràng)| 10    | REQ-03  | EP, BVA (TC-16)      |
| Ghi nhận SRS gap                     | 2     | REQ-03  | EP (quan sát)        |
