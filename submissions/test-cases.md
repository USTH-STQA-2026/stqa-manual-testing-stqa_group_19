...
|TC-06 |Member can only see their own borrow records |Logged in as ba.nguyen@email.com(MEM002). MEM002 has BR001 and BR004. |1. Go to "Borrow/Return" tab. 2. View "My borrow records" list. Note all records shown |Account: ba.nguyen@email.com |1. Only BR001 (BOOK003) and BR004 (BOOK005) are visible.1. Only BR001 (BOOK003) and BR004 (BOOK005) are visible. 2. Records from MEM003 (BR002, BR005) and MEM006 (BR003) are NOT visible. 3.Each record shows: record ID, book, borrow date, due date, status|REQ -08 |EP |
